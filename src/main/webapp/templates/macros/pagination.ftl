...
<#macro doPagination action id=-1>
	<#if (totalRecords > recordsPerPage)>
		...
		<div class="pages">
			...
			<input class="submit" type="button" value=" ${I18n.getMessage("ForumIndex.goToGo")} " onClick="goToAnotherPage(${totalPages}, ${recordsPerPage}, '${contextPath}', '${moduleName}', '${action}', ${id}, '${extension}');">
		</div>
	</#if>
</#macro>
