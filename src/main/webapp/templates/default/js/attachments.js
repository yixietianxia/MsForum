...
<#if attachmentsEnabled>
	var template = "<div id='attach_#counter#' width='100%'><table><tr><td width='12%'>${I18n.getMessage("Attachments.filename")}</td>";
	template += "<td><input width='100%' type='file' size='50' name='file_#counter#'></td></tr>";
	template += "<tr><td>${I18n.getMessage("Attachments.description")}</td>";
	template += "<td><input width='100%' type='text' name='comment_#counter#' size='50'><a href='javascript:removeAttach(#counter#)'>[${I18n.getMessage("Attachments.remove")}]</a>";
