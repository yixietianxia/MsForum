...
TopicModel.addNew = INSERT INTO jforum_topics (forum_id, topic_title, user_id, topic_time, topic_first_post_id, topic_last_post_id, topic_type, moderated) VALUES (?, ?, ?, ?, ?, ?, ?, ?)
...
# UserModel
# ##########
UserModel.lastGeneratedUserIdForAdd = SELECT MAX(user_id) from jforum_users
